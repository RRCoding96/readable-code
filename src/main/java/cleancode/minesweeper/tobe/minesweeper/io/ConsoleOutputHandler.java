...
import cleancode.minesweeper.tobe.minesweeper.io.sign.*;
...
//                String cellSign = cellSignFinder.findCellSingFrom(snapshot);
                String cellSign = CellSignProvider.findCellSingFrom(snapshot);
